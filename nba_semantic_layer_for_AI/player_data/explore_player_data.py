...
response = agent_executor.invoke({
    "input": "How many players are in the NBA_DB.PLAYER_DATA.PLAYER_DETAILS that played at Duke? List each player in the order in which they were drafted (ascending order of DRAFTROUND)."
})
